...
Or you can put content of particle system settings directly into your code to specified variable and just call initParticleSystem(<your particle settings>) to
