...
-- tooltip
skin.controls.tooltip_body_color                    = {255,255,160} --{93, 93, 93, 255}
skin.controls.tooltip_border_color					  = {0,0,0}
skin.controls.tooltip_text_color					  = {64,64,64,255}
...
function skin.DrawButton(object)
	...
	if down or checked then --xxx then
